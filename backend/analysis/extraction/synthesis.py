...
CATEGORY_OUTPUT_CONTRACTS = {
    "preview_criterios": (
        "- Sintetizar los criterios preliminares clave para evaluar rápidamente la oportunidad.\n"
        "- Priorizar bullets cortos, concretos y accionables para decisión temprana.\n"
        "- No duplicar texto completo de pliegos ni mezclar con identificación del procedimiento.\n"
        "- FORMATO OBLIGATORIO: un bullet por cada `tipo` recibido, nunca combinar dos tipos en un mismo bullet.\n"
        "  Cada bullet DEBE empezar con la etiqueta en español del tipo seguida de dos puntos y luego\n"
        "  la síntesis, es decir \"<Etiqueta>: <descripción>\". Nunca devolver la síntesis sola, sin la etiqueta.\n"
        "  Mapeo obligatorio tipo -> Etiqueta:\n"
        ...
        "  Si el item tiene `extraction_status` = \"not_found\" (o no hay evidencia real), el bullet debe ser\n"
        "  literalmente \"<Etiqueta>: No se encontró información.\" -- sin inventar ni completar con supuestos."
    ),
    "objeto_alcance": (
