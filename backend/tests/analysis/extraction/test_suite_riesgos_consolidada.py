...
def inventario_tests_backend():
    ...
    tests = {
        "R1.1 - Alta de categoría": ["test_extraction_riesgos.py", "test_riesgos_quick.py"],
        ...
        "R2.1 - Query expansion": ["test_query_expansion_riesgos_quick.py (7 tests)"],
        "R2.2 - Prompt dedicado": ["test_prompt_dedicado_riesgos_quick.py (9 tests)"],
        "R3.1 - Schema categoría": [
            "test_schema_riesgos_quick.py (9 tests)",
            "test_exports_riesgos_quick.py (2 tests)",
        ],
        "R3.2 - Evidencia por item": ["test_evidencia_riesgos_quick.py (6 tests)"],
        "R4.2 - Render bullet points": ["test_render_riesgos_quick.py (6 tests)"],
        "R4.3 - Estado sin riesgos": ["test_estado_sin_riesgos_ui_quick.py (6 tests)"],
    }
