...
from indexing.ai_search import (
    AzureSearchAdapter,
...
class TestAzureSearchAdapter:
    ...
    @patch("azure.search.documents.SearchClient")
    @patch("indexing.ai_search.sleep")
...
class TestUploadChunks:
    ...
    @patch("indexing.ai_search._build_adapter")
    @patch("indexing.ai_search.get_settings")
    @patch("indexing.ai_search.validate_index_contract")
