...
from analysis.extraction.engine.prompts import _describe_document, _format_chunks
...
def test_las_etiquetas_salen_de_los_documentos_del_analisis() -> None:
    from analysis.extraction.graph.documents import _build_document_labels
