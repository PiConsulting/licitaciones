"""Tests para módulo extraction.embeddings (Epic 11: caché LRU)."""
...
def mock_adapter():
    ...
    with patch("extraction.embeddings._build_adapter") as mock_build:
        adapter = MagicMock()
...
def test_embed_query_cache_hit(mock_adapter):
    ...
    """
    from extraction.embeddings import embed_query, _embed_query_cached
