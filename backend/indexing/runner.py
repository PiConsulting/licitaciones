...
from indexing.errors import DocumentTextExtractionError, ExtractionError
...
def _build_document_intelligence() -> DocumentIntelligencePort:
    return document_intelligence_adapter._build_adapter()


def _build_embeddings() -> EmbeddingsPort:
    return embeddings._build_adapter()
